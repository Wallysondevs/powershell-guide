import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Referência Rápida do PowerShell`,subtitle:`Cheat sheet completo: cmdlets essenciais, operadores, formatação e padrões comuns.`,difficulty:`iniciante`,timeToRead:`15 min`,children:[(0,i.jsx)(`p`,{children:`Esta referência rápida reúne os cmdlets, operadores e padrões mais usados no dia a dia do PowerShell. Use como consulta rápida ao trabalhar em scripts.`}),(0,i.jsx)(`h2`,{children:`Cmdlets Essenciais por Categoria`}),(0,i.jsx)(t,{title:`Get-Command rápido — os cmdlets mais usados`,code:`# ── ARQUIVOS E PASTAS ──────────────────────────────────────
...
`}),(0,i.jsx)(`h2`,{children:`Operadores Completos`}),(0,i.jsx)(t,{title:`Todos os operadores do PowerShell`,code:`# ── COMPARAÇÃO ────────────────────────────────────────────
...
`}),(0,i.jsx)(`h2`,{children:`Variáveis Automáticas Importantes`}),(0,i.jsx)(t,{title:`$_, $PSItem, $args e outras variáveis especiais`,code:`$_  / $PSItem         # Objeto atual no pipeline ou ForEach
...
`}),(0,i.jsx)(`h2`,{children:`Formatação de Strings`}),(0,i.jsx)(t,{title:`Formas de formatar e construir strings`,code:`$nome = "Ana"
$valor = 1234.567
...
"@
`}),(0,i.jsx)(`h2`,{children:`Padrões Comuns`}),(0,i.jsx)(t,{title:`Receitas prontas para uso diário`,code:`# Exportar para CSV e abrir no Excel
...
`}),(0,i.jsxs)(n,{type:`success`,title:`Dica: Tab Completion e Ctrl+Espaço`,children:[`O PowerShell tem auto-completar poderoso. Use `,(0,i.jsx)(`strong`,{children:`Tab`}),` para completar cmdlets, parâmetros, caminhos e muito mais. `,(0,i.jsx)(`strong`,{children:`Ctrl+Espaço`}),` mostra todas as opções disponíveis. Com PSReadLine, use as setas ↑↓ para pesquisar o histórico.`]})]})}export{a as default};