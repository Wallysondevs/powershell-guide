import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Rede Avançada`,subtitle:`DNS, DHCP, roteamento, adaptadores, firewall, proxy e diagnóstico avançado de rede com PowerShell.`,difficulty:`avançado`,timeToRead:`35 min`,children:[(0,i.jsx)(`p`,{children:`Além dos comandos básicos de rede, o PowerShell oferece módulos completos para gerenciar DNS, DHCP, adaptadores de rede, firewall do Windows, roteamento e diagnóstico detalhado de conectividade — tudo de forma automatizada e escalável.`}),(0,i.jsx)(`h2`,{children:`Adaptadores de Rede`}),(0,i.jsx)(t,{title:`Configurando interfaces de rede`,code:`# Listar adaptadores e configurações IP
  ...
  `}),(0,i.jsx)(`h2`,{children:`DNS — Servidor e Cliente`}),(0,i.jsx)(t,{title:`Gerenciando DNS no Windows Server`,code:`Import-Module DnsServer
  ...
  `}),(0,i.jsx)(`h2`,{children:`DHCP`}),(0,i.jsx)(t,{title:`Gerenciando servidor DHCP`,code:`Import-Module DhcpServer
  ...
  `}),(0,i.jsx)(`h2`,{children:`Firewall do Windows`}),(0,i.jsx)(t,{title:`Gerenciando regras de firewall`,code:`# Listar regras habilitadas (entrada)
  Get-NetFirewallRule |
  ...
  `}),(0,i.jsx)(`h2`,{children:`Diagnóstico Avançado de Rede`}),(0,i.jsx)(t,{title:`Ferramentas de diagnóstico e monitoramento`,code:`# Test-NetConnection — substituto ao ping + telnet
  ...
  `}),(0,i.jsxs)(n,{type:`info`,title:`Executar como Administrador`,children:[`A maioria dos cmdlets de rede (New-NetIPAddress, New-NetFirewallRule, DHCP, DNS) requer privilégios elevados. Execute o PowerShell como Administrador ou use`,(0,i.jsx)(`code`,{children:`Start-Process pwsh -Verb RunAs`}),`.`]})]})}export{a as default};