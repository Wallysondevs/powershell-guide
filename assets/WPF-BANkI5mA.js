import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Interfaces Gráficas com WPF/WinForms`,subtitle:`Crie GUIs nativas no Windows com Windows Forms e WPF diretamente em scripts PowerShell.`,difficulty:`avançado`,timeToRead:`30 min`,children:[(0,i.jsx)(`p`,{children:`PowerShell tem acesso completo às bibliotecas .NET de interface gráfica — Windows Forms e WPF (Windows Presentation Foundation). Isso permite criar ferramentas administrativas com interface visual, diálogos de arquivo, barras de progresso e formulários completos.`}),(0,i.jsxs)(n,{type:`info`,title:`Apenas no Windows`,children:[`Windows Forms e WPF estão disponíveis apenas no Windows. Para interfaces multiplataforma com PowerShell, use Terminal UI libraries como `,(0,i.jsx)(`code`,{children:`Spectre.Console`}),`.`]}),(0,i.jsx)(`h2`,{children:`Windows Forms — Básico`}),(0,i.jsx)(t,{title:`Caixa de mensagem e formulário simples`,code:`Add-Type -AssemblyName System.Windows.Forms
...
`}),(0,i.jsx)(`h2`,{children:`Formulário Completo com Windows Forms`}),(0,i.jsx)(t,{title:`Formulário de cadastro de servidor`,code:`Add-Type -AssemblyName System.Windows.Forms
Add-Type -AssemblyName System.Drawing
...
`}),(0,i.jsx)(`h2`,{children:`WPF com XAML`}),(0,i.jsx)(t,{title:`Interface moderna com WPF`,code:`Add-Type -AssemblyName PresentationFramework
...
`}),(0,i.jsxs)(n,{type:`success`,title:`Barra de Progresso em Scripts Longos`,children:[`Use `,(0,i.jsx)(`code`,{children:`Write-Progress`}),` para barras de progresso nativas no terminal, sem precisar de GUI: `,(0,i.jsx)(`code`,{children:`Write-Progress -Activity "Processando" -Status "Item $i de $total" -PercentComplete ($i/$total*100)`})]})]})}export{a as default};