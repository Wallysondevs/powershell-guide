import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Arrays e Listas`,subtitle:`Arrays são coleções ordenadas de valores. Aprenda a criar, acessar, modificar e iterar sobre arrays de forma eficiente no PowerShell.`,difficulty:`iniciante`,timeToRead:`20 min`,children:[(0,i.jsxs)(`p`,{children:[`Um `,(0,i.jsx)(`strong`,{children:`array`}),` (ou vetor) é uma variável que armazena múltiplos valores em uma única estrutura. No PowerShell, arrays são extremamente versáteis — podem conter qualquer tipo de objeto, incluindo strings, números, objetos complexos e até outros arrays. Entender arrays é fundamental para processar coleções de dados retornadas por cmdlets como `,(0,i.jsx)(`code`,{children:`Get-Process`}),`, `,(0,i.jsx)(`code`,{children:`Get-ChildItem`}),` e outros.`]}),(0,i.jsx)(`h2`,{children:`1. Criando Arrays`}),(0,i.jsx)(`p`,{children:`Existem várias formas de criar um array no PowerShell. As mais comuns são:`}),(0,i.jsx)(t,{title:`Formas de criar arrays`,code:`# Forma 1: Usando o operador vírgula (,)
...
[int[]]$x = 1,2,3
$x.GetType().Name            # Retorna: Int32[]`}),(0,i.jsx)(`h2`,{children:`2. Acessando Elementos`}),(0,i.jsx)(t,{title:`Indexação e fatiamento de arrays`,code:`$cores = "Vermelho", "Verde", "Azul", "Amarelo", "Roxo"
...
# Número de elementos
$cores.Count       # 5
$cores.Length      # 5 (equivalente a .Count)`}),(0,i.jsxs)(n,{type:`info`,title:`Índices começam em 0`,children:[`No PowerShell (e na maioria das linguagens de programação), o primeiro elemento de um array está no índice `,(0,i.jsx)(`code`,{children:`0`}),`, não no `,(0,i.jsx)(`code`,{children:`1`}),`. O último elemento está em `,(0,i.jsx)(`code`,{children:`$array.Count - 1`}),`, ou simplesmente use `,(0,i.jsx)(`code`,{children:`$array[-1]`}),` para acessá-lo.`]}),(0,i.jsx)(`h2`,{children:`3. Propriedades e Métodos`}),(0,i.jsx)(t,{title:`Métodos e propriedades de arrays`,code:`$numeros = @(5, 3, 8, 1, 9, 2, 7, 4, 6)
...
$copia = $numeros.Clone()    # Ou: $copia = @() + $numeros`}),(0,i.jsx)(`h2`,{children:`4. Adicionando e Removendo Elementos`}),(0,i.jsxs)(n,{type:`warning`,title:`Arrays são de tamanho fixo!`,children:[`Arrays comuns em PowerShell (`,(0,i.jsx)(`code`,{children:`Object[]`}),`) têm tamanho fixo. Quando você usa `,(0,i.jsx)(`code`,{children:`+=`}),`para "adicionar" um elemento, o PowerShell na verdade cria um `,(0,i.jsx)(`strong`,{children:`novo array`}),` e copia tudo. Isso é ineficiente para loops com muitos elementos. Para arrays mutáveis, use `,(0,i.jsx)(`code`,{children:`ArrayList`}),` ou `,(0,i.jsx)(`code`,{children:`List<T>`}),`.`]}),(0,i.jsx)(t,{title:`Adicionando elementos (e os problemas de performance)`,code:`# Método comum com += (INEFICIENTE em loops grandes)
$lista = @(1, 2, 3)
...
} | Select-Object TotalSeconds`}),(0,i.jsx)(`h2`,{children:`5. ArrayList — Arrays Mutáveis e Eficientes`}),(0,i.jsx)(t,{title:`ArrayList para adição/remoção eficiente`,code:`# Criar um ArrayList (mutável, sem recriação)
...
} | Select-Object TotalSeconds`}),(0,i.jsx)(`h2`,{children:`6. List<T> — Listas Fortemente Tipadas (Moderno)`}),(0,i.jsx)(t,{title:`Generic List para máxima eficiência e segurança de tipos`,code:`# Criar uma List<string> (apenas strings são aceitas)
...
$array = $nomes.ToArray()`}),(0,i.jsx)(`h2`,{children:`7. Iterando Arrays`}),(0,i.jsx)(t,{title:`Formas de percorrer arrays`,code:`$frutas = "Maçã", "Banana", "Laranja", "Uva", "Melancia"
...
$frutas | ForEach-Object { $i = 0 } {
    "[$i] $_"
    $i++
}`}),(0,i.jsx)(`h2`,{children:`8. Métodos Funcionais: Where() e ForEach()`}),(0,i.jsx)(t,{title:`Processamento funcional de arrays (PS4+)`,code:`$processos = Get-Process
...
$comprimentos = $nomes.ForEach({ $_.Length })`}),(0,i.jsxs)(n,{type:`success`,title:`Dica de Performance: .Where() vs Where-Object`,children:[`Para arrays já carregados em memória, os métodos `,(0,i.jsx)(`code`,{children:`.Where()`}),` e `,(0,i.jsx)(`code`,{children:`.ForEach()`}),`são significativamente mais rápidos que `,(0,i.jsx)(`code`,{children:`Where-Object`}),` e `,(0,i.jsx)(`code`,{children:`ForEach-Object`}),`no pipeline, pois evitam a sobrecarga do pipeline. Use-os quando já tiver os dados em um array. Use `,(0,i.jsx)(`code`,{children:`Where-Object`}),` no pipeline quando estiver processando dados que chegam de cmdlets.`]}),(0,i.jsx)(`h2`,{children:`9. Arrays de Objetos`}),(0,i.jsx)(t,{title:`Trabalhando com arrays de objetos complexos`,code:`# Arrays frequentemente contêm objetos, não apenas strings ou números
...
# Agrupar objetos
$porCidade = $pessoas | Group-Object Cidade`}),(0,i.jsx)(`h2`,{children:`10. Dicas e Boas Práticas`}),(0,i.jsx)(t,{title:`Dicas essenciais para trabalhar com arrays`,code:`# 1. Use @() para garantir que o resultado é sempre um array
...
$colunas = $linha -split ","     # @("Nome", "Idade", "Cidade")`})]})}export{a as default};