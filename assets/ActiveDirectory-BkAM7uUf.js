import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Active Directory com PowerShell`,subtitle:`Gerencie usuários, grupos, OUs, computadores, contas de serviço e políticas em ambientes Windows Server.`,difficulty:`avançado`,timeToRead:`45 min`,children:[(0,i.jsxs)(`p`,{children:[`O módulo `,(0,i.jsx)(`code`,{children:`ActiveDirectory`}),` (parte do RSAT) é uma das ferramentas mais poderosas para administração de ambientes Windows corporativos. Com ele é possível automatizar praticamente qualquer tarefa de gerenciamento de identidade, acesso e estrutura de domínio.`]}),(0,i.jsxs)(n,{type:`info`,title:`Instalação do RSAT`,children:[`Workstation: `,(0,i.jsx)(`code`,{children:`Get-WindowsCapability -Name "Rsat.ActiveDirectory*" -Online | Add-WindowsCapability -Online`}),(0,i.jsx)(`br`,{}),`Servidor: `,(0,i.jsx)(`code`,{children:`Install-WindowsFeature RSAT-AD-PowerShell`})]}),(0,i.jsx)(`h2`,{children:`Usuários — CRUD Completo`}),(0,i.jsx)(t,{title:`Criar, ler, modificar e excluir usuários`,code:`Import-Module ActiveDirectory
  ...
  `}),(0,i.jsx)(`h2`,{children:`Grupos`}),(0,i.jsx)(t,{title:`Gerenciamento de grupos de segurança e distribuição`,code:`# Criar grupo de segurança global
  ...
  `}),(0,i.jsx)(`h2`,{children:`Unidades Organizacionais (OUs)`}),(0,i.jsx)(t,{title:`Criando e gerenciando a estrutura de OUs`,code:`# Listar todas as OUs
  ...
  `}),(0,i.jsx)(`h2`,{children:`Contas de Serviço Gerenciadas (MSA/gMSA)`}),(0,i.jsx)(t,{title:`Contas de serviço seguras com senha automática`,code:`# gMSA (Group Managed Service Account) — senha gerenciada pelo AD automaticamente
  ...
  `}),(0,i.jsx)(`h2`,{children:`Computadores`}),(0,i.jsx)(t,{title:`Gerenciando contas de computador`,code:`# Buscar computadores com propriedades
  ...
  `}),(0,i.jsx)(`h2`,{children:`Relatórios, Auditoria e Importação em Massa`}),(0,i.jsx)(t,{title:`Relatórios de segurança, compliance e onboarding`,code:`# Contas inativas (sem login há 90+ dias)
  $limite = (Get-Date).AddDays(-90)
  ...
  `}),(0,i.jsxs)(n,{type:`warning`,title:`LastLogonDate vs LastLogon`,children:[`Use `,(0,i.jsx)(`code`,{children:`LastLogonDate`}),` (replicado entre DCs) em vez de `,(0,i.jsx)(`code`,{children:`LastLogon`}),`(armazenado apenas no DC que autenticou). Isso garante dados consistentes em ambientes com múltiplos controladores de domínio.`]})]})}export{a as default};