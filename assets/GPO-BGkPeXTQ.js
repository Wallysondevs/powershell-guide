import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Group Policy com PowerShell`,subtitle:`Crie, modifique, aplique, filtre e reporte políticas de grupo usando o módulo GroupPolicy.`,difficulty:`avançado`,timeToRead:`40 min`,children:[(0,i.jsx)(`p`,{children:`O módulo GroupPolicy permite gerenciar completamente as GPOs (Group Policy Objects) de um domínio Active Directory via PowerShell, automatizando a criação de políticas, geração de relatórios, aplicação em OUs específicas e filtragem avançada com WMI.`}),(0,i.jsxs)(n,{type:`info`,title:`Pré-requisito`,children:[`Instale o RSAT: `,(0,i.jsx)(`code`,{children:`Get-WindowsCapability -Online -Name "Rsat.GroupPolicy.Management.Tools*" | Add-WindowsCapability -Online`}),(0,i.jsx)(`br`,{}),`No Windows Server: `,(0,i.jsx)(`code`,{children:`Install-WindowsFeature GPMC`})]}),(0,i.jsx)(`h2`,{children:`Gerenciando GPOs`}),(0,i.jsx)(t,{title:`Criar, listar e modificar GPOs`,code:`Import-Module GroupPolicy
  ...
  Remove-GPRegistryValue -Name "Politica-Seguranca-TI" \`
    -Key "HKLM\\Software\\Policies\\Microsoft\\Windows NT\\Terminal Services" \`
    -ValueName "fDenyTSConnections"
  `}),(0,i.jsx)(`h2`,{children:`Filtros WMI`}),(0,i.jsx)(t,{title:`Aplicar GPOs apenas em hardware/SO específico`,code:`# Filtros WMI permitem aplicar GPOs apenas em máquinas que satisfazem critérios
  ...
  `}),(0,i.jsx)(`h2`,{children:`Filtragem de Segurança`}),(0,i.jsx)(t,{title:`Controlar quem recebe a GPO com permissões`,code:`# Ver filtragem de segurança atual de uma GPO
  ...
  `}),(0,i.jsx)(`h2`,{children:`Relatórios de GPO`}),(0,i.jsx)(t,{title:`Gerando relatórios HTML e XML`,code:`# Relatório HTML de uma GPO específica
  ...
  `}),(0,i.jsx)(`h2`,{children:`Backup e Restore de GPOs`}),(0,i.jsx)(t,{title:`Backup completo de políticas de grupo`,code:`$dataPasta = Get-Date -Format 'yyyyMMdd'
  ...
  Import-GPO -BackupId $backup.Id \`
    ...
    -CreateIfNeeded
  `}),(0,i.jsx)(`h2`,{children:`Resultante de Políticas (RSoP)`}),(0,i.jsx)(t,{title:`Analisando políticas aplicadas a um usuário/computador`,code:`# Simular RSoP — sem aplicar políticas, só visualizar o resultado
  ...
  `}),(0,i.jsxs)(n,{type:`info`,title:`GPO Enforced vs Block Inheritance`,children:[`Use `,(0,i.jsx)(`code`,{children:`-Enforced Yes`}),` no `,(0,i.jsx)(`code`,{children:`New-GPLink`}),` para que a GPO não possa ser sobreposta por OUs filhas. Use `,(0,i.jsx)(`code`,{children:`Set-GPInheritance -IsBlocked Yes`}),` em uma OU para bloquear herança de políticas de nível superior — útil em ambientes com políticas conflitantes entre departamentos.`]})]})}export{a as default};