import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Compressão e Arquivos`,subtitle:`Comprima, extraia, gerencie e automatize backups com ZIP, 7-Zip, tar e outros formatos.`,difficulty:`iniciante`,timeToRead:`25 min`,children:[(0,i.jsxs)(`p`,{children:[`O PowerShell oferece suporte nativo a arquivos ZIP através do namespace`,(0,i.jsx)(`code`,{children:`System.IO.Compression`}),` e dos cmdlets `,(0,i.jsx)(`code`,{children:`Compress-Archive`}),`e `,(0,i.jsx)(`code`,{children:`Expand-Archive`}),`. Para formatos avançados como 7z, tar e gz, use o 7-Zip ou ferramentas .NET adicionais.`]}),(0,i.jsx)(`h2`,{children:`Compress-Archive e Expand-Archive`}),(0,i.jsx)(t,{title:`Comprimindo e extraindo arquivos`,code:`# Comprimir pasta inteira
  ...
  `}),(0,i.jsx)(`h2`,{children:`Controle Granular com System.IO.Compression`}),(0,i.jsx)(t,{title:`Compressão avançada com a API .NET`,code:`Add-Type -AssemblyName System.IO.Compression.FileSystem
  ...
  `}),(0,i.jsx)(`h2`,{children:`Backup Automatizado com Rotação`}),(0,i.jsx)(t,{title:`Script de backup com retenção configurável`,code:`function New-Backup {
      param(
          [string]$Origem,
          [string]$DestinoPasta,
  ...
  `}),(0,i.jsx)(`h2`,{children:`7-Zip via PowerShell`}),(0,i.jsx)(t,{title:`Usando 7-Zip para formatos avançados`,code:`# Instalar 7-Zip
  ...
  `}),(0,i.jsx)(`h2`,{children:`Compressão de Strings e Streams`}),(0,i.jsx)(t,{title:`Comprimindo dados em memória com GZip`,code:`# Comprimir string na memória (útil para logs, JSON grande)
  ...
  `}),(0,i.jsxs)(n,{type:`info`,title:`7-Zip para Formatos Avançados`,children:[`Para formatos como 7z, RAR, tar.gz, use o 7-Zip via PowerShell. Instale com `,(0,i.jsx)(`code`,{children:`winget install 7zip.7zip`}),` e chame via`,(0,i.jsx)(`code`,{children:`& "C:\\Program Files\\7-Zip\\7z.exe"`}),`. O 7z oferece taxa de compressão superior ao ZIP nativo do Windows.`]}),(0,i.jsxs)(n,{type:`warning`,title:`Limite do Compress-Archive`,children:[`O cmdlet nativo `,(0,i.jsx)(`code`,{children:`Compress-Archive`}),` tem um limite de 2GB por arquivo de entrada. Para arquivos maiores, use `,(0,i.jsx)(`code`,{children:`System.IO.Compression.ZipFile`}),` ou 7-Zip.`]})]})}export{a as default};