import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Gerenciamento de Pacotes`,subtitle:`WinGet, Chocolatey, Scoop, PowerShellGet e automatização de ambientes com scripts.`,difficulty:`iniciante`,timeToRead:`25 min`,children:[(0,i.jsx)(`p`,{children:`Gerenciar software manualmente através de downloads e instaladores ".exe" é coisa do passado. O PowerShell integra-se com múltiplos gerenciadores de pacotes para instalar, atualizar e remover software de forma reproduzível e automatizável — em minutos, não horas.`}),(0,i.jsx)(`h2`,{children:`WinGet — Gerenciador Oficial da Microsoft`}),(0,i.jsx)(t,{title:`Instalando e gerenciando aplicativos com WinGet`,code:`# Buscar aplicativos pelo nome
  ...
  `}),(0,i.jsx)(`h2`,{children:`Chocolatey — O Gerenciador Corporativo`}),(0,i.jsx)(t,{title:`Instalação e uso do Chocolatey`,code:`# Instalar o Chocolatey (admin)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Scoop — Para Desenvolvedores`}),(0,i.jsx)(t,{title:`Instalações portáteis e sem admin`,code:`# Instalar Scoop (sem permissão de admin)
  ...
  `}),(0,i.jsx)(`h2`,{children:`PowerShellGet — Módulos do PowerShell`}),(0,i.jsx)(t,{title:`Gerenciando módulos e scripts PS`,code:`# Instalar módulo da PSGallery
  ...
  `}),(0,i.jsx)(`h2`,{children:`Automação de Ambiente — Setup Script Completo`}),(0,i.jsx)(t,{title:`Script para configurar máquina do zero`,code:`#Requires -RunAsAdministrator
  <#
  .SYNOPSIS
  ...
  `}),(0,i.jsxs)(n,{type:`info`,title:`WinGet Export/Import`,children:[`Use `,(0,i.jsx)(`code`,{children:`winget export -o apps.json`}),` para fazer backup de todos os aplicativos instalados e `,(0,i.jsx)(`code`,{children:`winget import -i apps.json`}),` para restaurar tudo em um novo PC. Ideal para migração de máquina ou onboarding de novos colaboradores.`]}),(0,i.jsxs)(n,{type:`warning`,title:`Escopo de Instalação`,children:[`Sempre use `,(0,i.jsx)(`code`,{children:`-Scope CurrentUser`}),` no `,(0,i.jsx)(`code`,{children:`Install-Module`}),` quando não tiver privilégios de Administrador. Sem esse parâmetro, o PowerShell tenta instalar para todos os usuários e falha com erro de permissão.`]})]})}export{a as default};