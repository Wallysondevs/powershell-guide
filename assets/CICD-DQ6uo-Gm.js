import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`CI/CD com PowerShell`,subtitle:`Integre PowerShell em pipelines de GitHub Actions, Azure DevOps e automação de deploy.`,difficulty:`avançado`,timeToRead:`30 min`,children:[(0,i.jsx)(`p`,{children:`PowerShell é uma excelente linguagem de automação para pipelines CI/CD. Ele pode ser usado em GitHub Actions, Azure DevOps, Jenkins e outros sistemas para build, teste, validação e deploy de aplicações.`}),(0,i.jsx)(`h2`,{children:`GitHub Actions com PowerShell`}),(0,i.jsx)(t,{title:`Workflow GitHub Actions usando PowerShell`,code:`# .github/workflows/deploy.yml
...
`}),(0,i.jsx)(`h2`,{children:`Script de Deploy Reutilizável`}),(0,i.jsx)(t,{title:`Deploy.ps1 — script de implantação`,code:`#Requires -Version 7.2
<#
.SYNOPSIS
...
`}),(0,i.jsx)(`h2`,{children:`Azure DevOps Pipeline`}),(0,i.jsx)(t,{title:`azure-pipelines.yml com PowerShell`,code:`# azure-pipelines.yml
trigger:
  - main
...
`}),(0,i.jsx)(`h2`,{children:`Notificações de Pipeline`}),(0,i.jsx)(t,{title:`Alertas de CI/CD via e-mail e Teams`,code:`function Send-NotificacaoCICD {
    param(
...
`}),(0,i.jsxs)(n,{type:`success`,title:`Boas Práticas de CI/CD com PowerShell`,children:[`Use `,(0,i.jsx)(`code`,{children:`#Requires -Version 7.2`}),` no topo dos scripts, sempre retorne código de saída com `,(0,i.jsx)(`code`,{children:`exit 1`}),` em falhas (não apenas throw), e salve resultados de testes em formato JUnit XML para visualização no painel do CI.`]})]})}export{a as default};