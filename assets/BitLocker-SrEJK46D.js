import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`BitLocker com PowerShell`,subtitle:`Habilite, monitore, gerencie e audite criptografia de disco com BitLocker em escala corporativa.`,difficulty:`avançado`,timeToRead:`35 min`,children:[(0,i.jsx)(`p`,{children:`O BitLocker protege dados em repouso criptografando volumes inteiros. O PowerShell oferece controle completo sobre habilitação, monitoramento, recuperação e auditoria do BitLocker em toda a empresa, integrado ao Active Directory e ao Microsoft Intune.`}),(0,i.jsx)(`h2`,{children:`Habilitando BitLocker`}),(0,i.jsx)(t,{title:`Criptografando volumes com BitLocker`,code:`# Verificar status de todos os volumes
  ...
  `}),(0,i.jsx)(`h2`,{children:`Backup de Chave de Recuperação`}),(0,i.jsx)(t,{title:`Fazendo backup das chaves no Active Directory`,code:`# Backup da chave de recuperação para AD (requer permissão no AD)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Monitoramento em Massa`}),(0,i.jsx)(t,{title:`Relatório de BitLocker em toda a empresa`,code:`# Via WMI em computadores remotos
  ...
  `}),(0,i.jsx)(`h2`,{children:`Recuperação e Suspensão`}),(0,i.jsx)(t,{title:`Operações de manutenção com BitLocker`,code:`# Suspender BitLocker temporariamente (para atualizações de firmware/BIOS)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Network Unlock (Desbloqueio por Rede)`}),(0,i.jsx)(t,{title:`Configurando Network Unlock para servidores`,code:`# Network Unlock permite que servidores iniciem sem intervenção manual
  ...
  `}),(0,i.jsx)(`h2`,{children:`Habilitação em Massa via Script`}),(0,i.jsx)(t,{title:`Automatizando BitLocker em múltiplos computadores`,code:`function Enable-BitLockerMassa {
      param(
          [string[]]$Computadores,
          [string]$LogPath = "C:LogsBitLocker-$(Get-Date -Format 'yyyyMMdd').csv"
      )
  ...
  `}),(0,i.jsx)(`h2`,{children:`Gerenciamento de PIN e Protetores`}),(0,i.jsx)(t,{title:`Alterando e gerenciando protetores de chave`,code:`# Alterar PIN do BitLocker
  ...
  `}),(0,i.jsx)(n,{type:`warning`,title:`Guarde as Chaves de Recuperação`,children:`Sempre faça backup das chaves de recuperação do BitLocker no Active Directory ou em local seguro. Sem a chave de recuperação, dados em volumes criptografados são irrecuperáveis caso o TPM seja resetado, o PIN seja esquecido ou a placa-mãe seja trocada.`}),(0,i.jsxs)(n,{type:`info`,title:`Algoritmos de Criptografia`,children:[`Use `,(0,i.jsx)(`code`,{children:`XtsAes256`}),` para discos fixos (mais seguro) e `,(0,i.jsx)(`code`,{children:`XtsAes128`}),`para compatibilidade com versões antigas do Windows. Para unidades removíveis use`,(0,i.jsx)(`code`,{children:`Aes256`}),` (BitLocker To Go).`]})]})}export{a as default};