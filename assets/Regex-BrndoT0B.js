import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Expressões Regulares`,subtitle:`Domine o poder das regex para validação, extração e transformação de textos.`,difficulty:`intermediário`,timeToRead:`25 min`,children:[(0,i.jsxs)(`p`,{children:[`Expressões regulares (regex) são padrões usados para encontrar, validar e manipular strings. No PowerShell, você pode usar regex com operadores nativos como `,(0,i.jsx)(`code`,{children:`-match`}),`, `,(0,i.jsx)(`code`,{children:`-replace`}),`,`,(0,i.jsx)(`code`,{children:`-split`}),` e com cmdlets como `,(0,i.jsx)(`code`,{children:`Select-String`}),`.`]}),(0,i.jsx)(`h2`,{children:`Operadores de Regex`}),(0,i.jsx)(t,{title:`Operadores -match, -replace e -split`,code:`# -match: testa se string combina com padrão
...
`}),(0,i.jsx)(`h2`,{children:`Select-String para Busca em Arquivos`}),(0,i.jsx)(t,{title:`Grep-like com Select-String`,code:`# Buscar em um arquivo
Select-String -Path "C:Logsapp.log" -Pattern "ERROR|FATAL"
...
`}),(0,i.jsx)(`h2`,{children:`Grupos Nomeados`}),(0,i.jsx)(t,{title:`Capturando com grupos nomeados`,code:`# Grupos nomeados com (?<nome>padrão)
...
`}),(0,i.jsx)(`h2`,{children:`Classe [regex] .NET`}),(0,i.jsx)(t,{title:`Usando a classe .NET diretamente`,code:`# Objeto regex para reutilização e mais controle
...
`}),(0,i.jsx)(`h2`,{children:`Validações com Regex`}),(0,i.jsx)(t,{title:`Padrões de validação comuns`,code:`function Test-Email([string]$email) {
...
`}),(0,i.jsxs)(n,{type:`info`,title:`Cheat Sheet de Regex`,children:[(0,i.jsx)(`strong`,{children:`Âncoras:`}),` ^ início, $ fim, \\b borda de palavra.`,(0,i.jsx)(`strong`,{children:`Quantificadores:`}),` * (0+), + (1+), ? (0/1), `,`{n,m}`,` (n a m vezes).`,(0,i.jsx)(`strong`,{children:`Classes:`}),` \\d dígito, \\w palavra, \\s espaço, \\D \\W \\S (negações).`,(0,i.jsx)(`strong`,{children:`Grupos:`}),` () captura, (?:) sem captura, (?`,`<`,`nome`,`>`,`) nomeado, | alternativa.`]})]})}export{a as default};