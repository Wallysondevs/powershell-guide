import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Primeiros Passos`,subtitle:`Dominando a interface, atalhos, conceitos fundamentais e o perfil do PowerShell.`,difficulty:`iniciante`,timeToRead:`20 min`,children:[(0,i.jsx)(`p`,{children:`Seja bem-vindo ao PowerShell! Nesta seção você aprenderá a abrir o terminal, entender a filosofia Verbo-Substantivo, navegar pelo sistema de arquivos, usar atalhos de produtividade e personalizar seu ambiente com o perfil.`}),(0,i.jsx)(`h2`,{children:`Abrindo o PowerShell`}),(0,i.jsx)(t,{title:`Formas de abrir o terminal`,code:`# Windows PowerShell 5.1 (já vem no Windows)
  ...
  `}),(0,i.jsx)(`h2`,{children:`A Filosofia Verbo-Substantivo`}),(0,i.jsx)(t,{title:`Entendendo a nomenclatura dos cmdlets`,code:`# Todo cmdlet segue o padrão: Verbo-Substantivo
  ...
  `}),(0,i.jsx)(`h2`,{children:`Atalhos de Teclado (Produtividade)`}),(0,i.jsx)(t,{title:`Os atalhos mais importantes do terminal`,code:`# === AUTOCOMPLETAR ===
  ...
  `}),(0,i.jsx)(`h2`,{children:`Navegação Básica`}),(0,i.jsx)(t,{title:`Movendo pelo sistema de arquivos`,code:`# Aliases de navegação (iguais ao Bash e CMD)
  ...
  Get-ChildItem
  `}),(0,i.jsx)(`h2`,{children:`Ajuda Integrada`}),(0,i.jsx)(t,{title:`Usando o sistema de Help do PowerShell`,code:`# Atualizar a documentação de Help (faça uma vez — requer internet)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Interagindo com Objetos`}),(0,i.jsx)(t,{title:`O poder dos objetos no pipeline`,code:`# PowerShell retorna objetos, não texto!
  ...
  `}),(0,i.jsx)(`h2`,{children:`O Perfil do PowerShell`}),(0,i.jsx)(t,{title:`Personalizando o terminal com o arquivo de perfil`,code:`# Localização do perfil (arquivo que roda ao iniciar PS)
  ...
  . $PROFILE
  `}),(0,i.jsxs)(n,{type:`info`,title:`Execution Policy`,children:[`Na primeira vez que tentar rodar scripts `,(0,i.jsx)(`code`,{children:`.ps1`}),`, pode aparecer um erro de Execution Policy. Para liberar scripts locais, execute como admin:`,(0,i.jsx)(`code`,{children:`Set-ExecutionPolicy RemoteSigned -Scope CurrentUser`})]}),(0,i.jsxs)(n,{type:`success`,title:`Dica: Windows Terminal`,children:[`Instale o `,(0,i.jsx)(`strong`,{children:`Windows Terminal`}),` (`,(0,i.jsx)(`code`,{children:`winget install Microsoft.WindowsTerminal`}),`) para uma experiência muito melhor: abas, temas, fontes Nerd Font, suporte a GPU e integração com WSL, PowerShell e CMD em um único lugar.`]})]})}export{a as default};