import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Testes com Pester`,subtitle:`Escreva testes unitários e de integração para scripts e módulos PowerShell com o Pester.`,difficulty:`avançado`,timeToRead:`30 min`,children:[(0,i.jsx)(`p`,{children:`Pester é o framework de testes padrão do PowerShell. Permite escrever testes unitários e de integração para verificar que seu código funciona conforme esperado, facilitando refatorações seguras e integração com pipelines CI/CD.`}),(0,i.jsx)(`h2`,{children:`Instalação e Estrutura Básica`}),(0,i.jsx)(t,{title:`Primeiro teste com Pester`,code:`# Instalar Pester (versão mais recente)
...
`}),(0,i.jsx)(`h2`,{children:`Assertions Disponíveis`}),(0,i.jsx)(t,{title:`Todos os tipos de Should`,code:`# Igualdade
42 | Should -Be 42
42 | Should -Not -Be 0
...
`}),(0,i.jsx)(`h2`,{children:`Mocking — Isolando Dependências`}),(0,i.jsx)(t,{title:`Mock para simular chamadas externas`,code:`# Função a ser testada (contém dependências externas)
...
`}),(0,i.jsx)(`h2`,{children:`BeforeAll, BeforeEach e Limpeza`}),(0,i.jsx)(t,{title:`Configuração e teardown dos testes`,code:`Describe "Testes de Arquivo" {
    BeforeAll {
...
`}),(0,i.jsx)(`h2`,{children:`Executando e Integrando com CI`}),(0,i.jsx)(t,{title:`Invoke-Pester e relatórios`,code:`# Executar todos os testes
Invoke-Pester
...
`}),(0,i.jsxs)(n,{type:`success`,title:`Code Coverage`,children:[`A cobertura de código mostra quais linhas do seu script foram executadas durante os testes. Tente manter acima de 80% para funções críticas. Use `,(0,i.jsx)(`code`,{children:`$config.CodeCoverage.Enabled = $true`}),` para gerar o relatório.`]})]})}export{a as default};