import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Objetos Personalizados`,subtitle:`Crie, combine, estenda, ordene e serialize objetos com PSCustomObject, TypeData e propriedades calculadas.`,difficulty:`intermediário`,timeToRead:`30 min`,children:[(0,i.jsx)(`p`,{children:`No PowerShell, tudo é um objeto. Entender como criar objetos personalizados, adicionar propriedades e métodos, manipular o sistema de tipos e serializar dados é fundamental para scripts avançados, bem estruturados e reutilizáveis.`}),(0,i.jsx)(`h2`,{children:`PSCustomObject — Criação e Coleções`}),(0,i.jsx)(t,{title:`Criando objetos estruturados`,code:`# Forma recomendada: literal de hashtable com cast (PS 3+)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Add-Member — Adicionando Propriedades e Métodos`}),(0,i.jsx)(t,{title:`Estendendo objetos existentes`,code:`# NoteProperty — valor fixo
  ...
  `}),(0,i.jsx)(`h2`,{children:`Select-Object com Propriedades Calculadas`}),(0,i.jsx)(t,{title:`Transformando objetos no pipeline`,code:`# Propriedades calculadas: @{N='Rótulo'; E={Expressão}}
  ...
  `}),(0,i.jsx)(`h2`,{children:`Update-TypeData — Tipos Personalizados`}),(0,i.jsx)(t,{title:`Estendendo tipos .NET com propriedades permanentes`,code:`# Adicionar propriedades a FileInfo (todos os objetos de arquivo ganham a propriedade)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Serialização e Comparação de Objetos`}),(0,i.jsx)(t,{title:`JSON, XML e comparação de objetos`,code:`# Serializar para JSON (PowerShell 7 tem ConvertTo-Json mais rico)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Grupos e Agregações`}),(0,i.jsx)(t,{title:`Group-Object e Measure-Object avançados`,code:`# Agrupar e sumarizar processos por empresa
  ...
  `}),(0,i.jsxs)(n,{type:`info`,title:`PSCustomObject vs New-Object PSObject`,children:[`Prefira sempre `,(0,i.jsxs)(`code`,{children:[`[PSCustomObject]@`,`{`,`...`,`}`]}),` em vez de `,(0,i.jsx)(`code`,{children:`New-Object PSObject`}),`ou `,(0,i.jsxs)(`code`,{children:[`New-Object PSObject -Property @`,`{`,`...`,`}`]}),`. O cast literal é até 10x mais rápido, mantém a ordem das propriedades e tem sintaxe mais limpa.`]})]})}export{a as default};