import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Banco de Dados com PowerShell`,subtitle:`Conecte-se a SQL Server, execute queries, gerencie backups e automatize operações de banco de dados.`,difficulty:`avançado`,timeToRead:`30 min`,children:[(0,i.jsx)(`p`,{children:`PowerShell pode interagir com bancos de dados SQL Server via módulo SqlServer, ADO.NET direto ou ODBC. Isso permite automatizar backups, executar relatórios, monitorar saúde do banco e muito mais.`}),(0,i.jsx)(`h2`,{children:`Módulo SqlServer`}),(0,i.jsx)(t,{title:`Instalando e usando o módulo SqlServer`,code:`# Instalar módulo (recomendado)
...
`}),(0,i.jsx)(`h2`,{children:`ADO.NET Direto`}),(0,i.jsx)(t,{title:`Conexão e queries com ADO.NET`,code:`function Invoke-Query {
    param(
...
`}),(0,i.jsx)(`h2`,{children:`Backup e Restore Automatizados`}),(0,i.jsx)(t,{title:`Backup de bancos SQL Server`,code:`# Backup via T-SQL com Invoke-Sqlcmd
...
Get-ChildItem $pasta -Filter "*.bak" |
    ...
    Remove-Item -Force
`}),(0,i.jsx)(`h2`,{children:`Monitoramento de SQL Server`}),(0,i.jsx)(t,{title:`Saúde e performance do banco`,code:`# Tamanho dos bancos de dados
...
"@
`}),(0,i.jsxs)(n,{type:`info`,title:`Segurança: SQL Injection`,children:[`Sempre use parâmetros (`,(0,i.jsx)(`code`,{children:`@parametro`}),`) ao passar dados do usuário para queries SQL. Nunca construa queries concatenando strings — isso abre brechas de SQL Injection.`]})]})}export{a as default};