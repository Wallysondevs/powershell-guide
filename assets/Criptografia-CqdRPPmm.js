import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Criptografia e Segurança de Dados`,subtitle:`Hash MD5/SHA, AES, RSA, assinaturas digitais, certificados e SecretManagement.`,difficulty:`avançado`,timeToRead:`35 min`,children:[(0,i.jsxs)(`p`,{children:[`PowerShell tem acesso completo à biblioteca criptográfica do .NET (`,(0,i.jsx)(`code`,{children:`System.Security.Cryptography`}),`), permitindo calcular hashes, criptografar/descriptografar dados, assinar arquivos e gerenciar certificados digitais — tudo sem dependências externas.`]}),(0,i.jsx)(`h2`,{children:`Hashing de Arquivos e Strings`}),(0,i.jsx)(t,{title:`Calculando e verificando hashes`,code:`# Cmdlet nativo Get-FileHash (SHA256 é o padrão)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Criptografia AES Simétrica`}),(0,i.jsx)(t,{title:`Criptografar e descriptografar dados com AES-256-CBC`,code:`function Protect-String {
  ...
  `}),(0,i.jsx)(`h2`,{children:`SecretManagement — Cofre de Senhas`}),(0,i.jsx)(t,{title:`Armazenando segredos com Microsoft.PowerShell.SecretManagement`,code:`# Instalar módulos
  ...
  `}),(0,i.jsx)(`h2`,{children:`Certificados Digitais`}),(0,i.jsx)(t,{title:`Gerenciando o repositório de certificados`,code:`# Listar certificados do repositório local
  ...
  `}),(0,i.jsxs)(n,{type:`warning`,title:`Nunca Hardcode Segredos`,children:[`Nunca coloque senhas, tokens ou chaves diretamente no código-fonte. Use variáveis de ambiente (`,(0,i.jsx)(`code`,{children:`$env:DB_PASSWORD`}),`), o módulo `,(0,i.jsx)(`code`,{children:`SecretManagement`}),` ou serviços como Azure Key Vault ou AWS Secrets Manager para armazenar segredos de forma segura.`]}),(0,i.jsxs)(n,{type:`info`,title:`Diferença entre Criptografia e Hashing`,children:[(0,i.jsx)(`strong`,{children:`Hash`}),` (SHA256, bcrypt, PBKDF2): unidirecional — não é possível reverter. Use para senhas, integridade de arquivos, assinaturas.`,(0,i.jsx)(`strong`,{children:`Criptografia`}),` (AES, RSA): bidirecional — você pode descriptografar com a chave correta. Use para dados que precisam ser recuperados.`]})]})}export{a as default};