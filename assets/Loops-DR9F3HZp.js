import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Loops Avançados e Iteração`,subtitle:`For, ForEach, While, Do-While, ForEach-Object e técnicas de controle de fluxo em loops.`,difficulty:`intermediário`,timeToRead:`20 min`,children:[(0,i.jsx)(`p`,{children:`PowerShell oferece múltiplos mecanismos de iteração, cada um com suas características de performance e legibilidade. Conhecer quando usar cada um é essencial para escrever scripts eficientes.`}),(0,i.jsx)(`h2`,{children:`Tipos de Loop e Performance`}),(0,i.jsx)(t,{title:`For, ForEach, While e suas diferenças`,code:`# For clássico — ideal para índices
for ($i = 0; $i -lt 10; $i++) {
    "Iteração $i"
}
...
`}),(0,i.jsx)(`h2`,{children:`break, continue e labels`}),(0,i.jsx)(t,{title:`Controle de fluxo dentro de loops`,code:`# break — sair do loop atual
foreach ($n in 1..100) {
...
`}),(0,i.jsx)(`h2`,{children:`ForEach-Object Avançado`}),(0,i.jsx)(t,{title:`Blocos Begin, Process e End no pipeline`,code:`# ForEach-Object com Begin/Process/End
...
`}),(0,i.jsx)(`h2`,{children:`Loops Infinitos Controlados`}),(0,i.jsx)(t,{title:`Polling e monitoramento contínuo`,code:`# Loop infinito com condição de saída
$maxTentativas = 10
$tentativa = 0
...
`}),(0,i.jsxs)(n,{type:`info`,title:`Performance de Loops`,children:[(0,i.jsx)(`code`,{children:`foreach`}),` (statement) é mais rápido que `,(0,i.jsx)(`code`,{children:`ForEach-Object`}),` (cmdlet) para coleções em memória. Use `,(0,i.jsx)(`code`,{children:`ForEach-Object`}),` para streaming no pipeline (processamento linha por linha de arquivos grandes).`]})]})}export{a as default};