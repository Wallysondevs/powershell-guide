import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Manipulação de Conteúdo de Arquivos`,subtitle:`Lendo, escrevendo, filtrando e processando dados em arquivos de texto e binários.`,difficulty:`intermediario`,timeToRead:`28 min`,children:[(0,i.jsx)(`p`,{children:`Ler e escrever conteúdo em arquivos é uma tarefa diária. O PowerShell trata conteúdo de arquivo como arrays de objetos, tornando filtragem, substituição e processamento em lote muito mais elegantes que ferramentas de texto simples.`}),(0,i.jsx)(`h2`,{children:`Lendo Conteúdo com Get-Content`}),(0,i.jsx)(t,{title:`Diferentes formas de ler arquivos`,code:`# Ler arquivo inteiro (retorna array de strings — uma por linha)
  ...
  $reader.Close()
  `}),(0,i.jsx)(`h2`,{children:`Escrevendo Conteúdo`}),(0,i.jsx)(t,{title:`Set-Content, Add-Content e Out-File`,code:`# Set-Content — sobrescreve o arquivo (ou cria se não existir)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Codificação de Caracteres`}),(0,i.jsx)(t,{title:`Trabalhando com diferentes encodings`,code:`# Especificar encoding ao ler
  ...
  `}),(0,i.jsxs)(n,{type:`warning`,title:`UTF-8 com e sem BOM`,children:[`No Windows PowerShell 5.1 o padrão é UTF-16. No PowerShell 7+ é UTF-8 sem BOM. Scripts e arquivos de config criados no PS5.1 com acentos podem ter problemas ao serem abertos no PS7. Sempre especifique `,(0,i.jsx)(`code`,{children:`-Encoding UTF8`}),` explicitamente.`]}),(0,i.jsx)(`h2`,{children:`Processamento via Pipeline`}),(0,i.jsx)(t,{title:`Filtragem, substituição e transformação de linhas`,code:`# Filtrar linhas que contêm uma palavra
  ...
  `}),(0,i.jsx)(`h2`,{children:`Formatos Estruturados: JSON, CSV e XML`}),(0,i.jsx)(t,{title:`Ler e escrever dados estruturados`,code:`# JSON — ler, modificar e salvar
  ...
  `}),(0,i.jsx)(`h2`,{children:`Manipulação de Arquivos Binários`}),(0,i.jsx)(t,{title:`Lendo e escrevendo dados binários`,code:`# Ler arquivo binário como bytes
  ...
  `}),(0,i.jsxs)(n,{type:`info`,title:`Performance: Get-Content vs System.IO.File`,children:[(0,i.jsx)(`code`,{children:`Get-Content`}),` é conveniente mas carrega o arquivo inteiro em memória como array. Para arquivos grandes use `,(0,i.jsx)(`code`,{children:`[System.IO.File]::ReadLines()`}),` que faz streaming linha por linha sem consumir toda a RAM. Para binários, sempre use`,(0,i.jsx)(`code`,{children:`[System.IO.File]::ReadAllBytes()`}),`.`]})]})}export{a as default};