import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Hyper-V com PowerShell`,subtitle:`Crie, configure, gerencie, replique e automatize máquinas virtuais Hyper-V.`,difficulty:`avançado`,timeToRead:`35 min`,children:[(0,i.jsx)(`p`,{children:`O módulo Hyper-V do PowerShell permite gerenciar completamente a plataforma de virtualização da Microsoft: criar e configurar VMs, gerenciar snapshots, configurar redes virtuais, gerenciar discos VHDX e automatizar replicação e migração.`}),(0,i.jsxs)(n,{type:`info`,title:`Pré-requisito`,children:[`Requer Windows 10/11 Pro/Enterprise ou Windows Server com Hyper-V habilitado. Ative via: `,(0,i.jsx)(`code`,{children:`Enable-WindowsOptionalFeature -Online -FeatureName Microsoft-Hyper-V -All`})]}),(0,i.jsx)(`h2`,{children:`Gerenciamento de VMs`}),(0,i.jsx)(t,{title:`Criar, iniciar e monitorar VMs`,code:`# Listar VMs com uso de recursos
  ...
  `}),(0,i.jsx)(`h2`,{children:`Snapshots e Checkpoints`}),(0,i.jsx)(t,{title:`Gerenciando checkpoints de forma segura`,code:`# Criar checkpoint
  ...
  `}),(0,i.jsx)(`h2`,{children:`Gerenciamento de VHDX`}),(0,i.jsx)(t,{title:`Criando, redimensionando e otimizando discos virtuais`,code:`# Criar VHDX de tamanho fixo (melhor performance)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Exportação, Clonagem e Backup`}),(0,i.jsx)(t,{title:`Exportar, importar e automatizar backups`,code:`# Exportar VM completa (inclui todos os arquivos)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Redes Virtuais e Live Migration`}),(0,i.jsx)(t,{title:`Switches, adaptadores e migração sem downtime`,code:`# Listar e criar switches virtuais
  ...
  `}),(0,i.jsx)(n,{type:`info`,title:`Checkpoints em Produção`,children:`Evite manter checkpoints em VMs de produção por longos períodos — eles acumulam um arquivo de diferença (AVHDX) que cresce continuamente e pode degradar a performance. Use-os apenas para testes antes/depois de atualizações e remova logo em seguida.`})]})}export{a as default};