import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Permissões de Arquivos e ACLs`,subtitle:`Gerencie Listas de Controle de Acesso (ACL), proprietários, herança e auditoria no Windows.`,difficulty:`avancado`,timeToRead:`30 min`,children:[(0,i.jsxs)(`p`,{children:[`O sistema de permissões do Windows baseia-se em ACLs (Access Control Lists). Cada arquivo e pasta tem uma DACL (controle de acesso) e uma SACL (auditoria). PowerShell oferece `,(0,i.jsx)(`code`,{children:`Get-Acl`}),` e `,(0,i.jsx)(`code`,{children:`Set-Acl`}),` para ler e modificar essas permissões programaticamente.`]}),(0,i.jsx)(`h2`,{children:`Visualizando Permissões com Get-Acl`}),(0,i.jsx)(t,{title:`Inspecionando ACLs de arquivos e pastas`,code:`# Permissão de um arquivo
  ...
  `}),(0,i.jsx)(`h2`,{children:`Modificando Permissões — O Fluxo Correto`}),(0,i.jsx)(t,{title:`Adicionando e modificando entradas de ACL`,code:`# Fluxo: Get-Acl → Criar regra → Adicionar → Set-Acl
  ...
  `}),(0,i.jsx)(`h2`,{children:`Removendo Permissões`}),(0,i.jsx)(t,{title:`Removendo entradas específicas de ACL`,code:`# Remover permissão específica de um usuário
  ...
  $acl.Access |
      ...
      ForEach-Object { $acl.RemoveAccessRule($_) }
  Set-Acl -Path $caminho -AclObject $acl
  `}),(0,i.jsx)(`h2`,{children:`Gerenciando Herança`}),(0,i.jsx)(t,{title:`Bloqueando e restaurando herança de ACL`,code:`# Verificar herança de uma pasta
  ...
  `}),(0,i.jsx)(`h2`,{children:`Alterando o Proprietário`}),(0,i.jsx)(t,{title:`Mudando o Owner de arquivos e pastas`,code:`# Ver proprietário atual
  ...
  `}),(0,i.jsx)(`h2`,{children:`Auditoria de Permissões`}),(0,i.jsx)(t,{title:`Encontrar arquivos com permissões problemáticas`,code:`# Arquivos acessíveis por "Everyone" (risco de segurança)
  ...
  `}),(0,i.jsxs)(n,{type:`warning`,title:`Cuidado com Deny`,children:[`Regras `,(0,i.jsx)(`code`,{children:`Deny`}),` têm precedência sobre `,(0,i.jsx)(`code`,{children:`Allow`}),`, mesmo que o usuário seja membro de um grupo com permissão Allow. Use Deny com cautela — prefira estruturar os grupos de AD para controlar acesso em vez de usar Deny explícito.`]}),(0,i.jsxs)(n,{type:`info`,title:`Alternativa: icacls`,children:[`Para operações em massa ou recursivas em muitos arquivos, `,(0,i.jsx)(`code`,{children:`icacls.exe`}),`é significativamente mais rápido que o PowerShell Get-Acl/Set-Acl em loop. Use PowerShell para lógica e `,(0,i.jsx)(`code`,{children:`icacls`}),` para execução em lote.`]})]})}export{a as default};