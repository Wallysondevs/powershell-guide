import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{t as n}from"./AlertBox-q8pQIQ07.js";import{a as r}from"./index-D0tfvO9Z.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`Azure PowerShell`,subtitle:`Gerencie VMs, storage, redes, RBAC, App Services e muito mais com o módulo Az.`,difficulty:`avançado`,timeToRead:`40 min`,children:[(0,i.jsx)(`p`,{children:`O módulo Az é a interface oficial do PowerShell para gerenciar recursos no Microsoft Azure. Com mais de 70 sub-módulos, cobre desde VMs e storage até Kubernetes, Functions, bancos de dados e segurança — tudo com suporte a automação e CI/CD.`}),(0,i.jsx)(`h2`,{children:`Instalação e Autenticação`}),(0,i.jsx)(t,{title:`Configurando o ambiente Az`,code:`# Instalar módulo Az
  ...
  `}),(0,i.jsx)(`h2`,{children:`Resource Groups e VMs`}),(0,i.jsx)(t,{title:`Gerenciando máquinas virtuais`,code:`# Resource Groups
  ...
  `}),(0,i.jsx)(`h2`,{children:`Storage Account`}),(0,i.jsx)(t,{title:`Gerenciando blobs, filas e tabelas`,code:`# Criar Storage Account
  ...
  `}),(0,i.jsx)(`h2`,{children:`Redes e Segurança`}),(0,i.jsx)(t,{title:`VNets, NSGs e firewall`,code:`# Criar Virtual Network e subnet
  ...
  `}),(0,i.jsx)(`h2`,{children:`RBAC e Políticas de Acesso`}),(0,i.jsx)(t,{title:`Controle de acesso com funções e políticas`,code:`# Listar atribuições de função (RBAC)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Tags e Gestão de Custos`}),(0,i.jsx)(t,{title:`Organizando recursos com tags e monitorando custos`,code:`# Aplicar tags a um Resource Group
  ...
  `}),(0,i.jsxs)(n,{type:`info`,title:`Az vs AzureRM`,children:[`O módulo `,(0,i.jsx)(`code`,{children:`Az`}),` é o módulo atual e recomendado. O antigo `,(0,i.jsx)(`code`,{children:`AzureRM`}),`foi aposentado em 29 de fevereiro de 2024. Migre seus scripts para `,(0,i.jsx)(`code`,{children:`Az`}),`. Geralmente basta renomear `,(0,i.jsx)(`code`,{children:`Login-AzureRmAccount`}),` para `,(0,i.jsx)(`code`,{children:`Connect-AzAccount`}),`e `,(0,i.jsx)(`code`,{children:`AzureRm`}),` para `,(0,i.jsx)(`code`,{children:`Az`}),` nos nomes dos cmdlets.`]})]})}export{a as default};