import{n as e,t}from"./CodeBlock-DVOG-hPm.js";import{a as n}from"./index-D0tfvO9Z.js";var r=n();function i(){return(0,r.jsxs)(e,{title:`Datas e Horas`,subtitle:`Manipule, formate, calcule e converta datas e horas com precisão usando Get-Date e [datetime].`,difficulty:`iniciante`,timeToRead:`20 min`,children:[(0,r.jsxs)(`p`,{children:[`O PowerShell usa o tipo `,(0,r.jsx)(`code`,{children:`[datetime]`}),` do .NET para representar datas e horas. O cmdlet `,(0,r.jsx)(`code`,{children:`Get-Date`}),` é sua porta de entrada, mas há muito mais no tipo`,(0,r.jsx)(`code`,{children:`System.DateTime`}),` para cálculos, fusos horários e formatação avançada.`]}),(0,r.jsx)(`h2`,{children:`Get-Date e Criando Datas`}),(0,r.jsx)(t,{title:`Obtendo e criando objetos de data`,code:`# Data e hora atual
Get-Date
(Get-Date).ToString()
...
`}),(0,r.jsx)(`h2`,{children:`Formatando Datas`}),(0,r.jsx)(t,{title:`Formatação de saída`,code:`$d = Get-Date
...
`}),(0,r.jsx)(`h2`,{children:`Cálculos com Datas`}),(0,r.jsx)(t,{title:`Adicionando, subtraindo e comparando`,code:`$hoje = Get-Date
...
`}),(0,r.jsx)(`h2`,{children:`Fusos Horários`}),(0,r.jsx)(t,{title:`TimeZone e conversões`,code:`# Fuso atual
...
`}),(0,r.jsx)(`h2`,{children:`Primeiro e Último Dia do Mês`}),(0,r.jsx)(t,{title:`Cálculos comuns de calendário`,code:`$hoje = Get-Date
