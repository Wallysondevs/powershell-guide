import{n as e,t}from"./CodeBlock-BuNVzmc1.js";import{t as n}from"./AlertBox-BFckEFwP.js";import{a as r}from"./index-Cqr-t4Fn.js";var i=r();function a(){return(0,i.jsxs)(e,{title:`PowerShell 7 — Novidades e Diferenças`,subtitle:`Tudo o que há de novo no PowerShell 7+: operadores, paralelismo, erros, REST e mais.`,difficulty:`intermediário`,timeToRead:`30 min`,children:[(0,i.jsx)(`p`,{children:`O PowerShell 7 é uma reescrita cross-platform baseada no .NET 6+, enquanto o Windows PowerShell 5.1 usa o .NET Framework e é exclusivo do Windows. Ambos coexistem no sistema. O PS7 traz dezenas de novos recursos, melhor performance e compatibilidade com Linux e macOS.`}),(0,i.jsxs)(n,{type:`info`,title:`Dois PowerShells`,children:[(0,i.jsx)(`strong`,{children:`Windows PowerShell 5.1`}),` — `,(0,i.jsx)(`code`,{children:`powershell.exe`}),`: já incluso no Windows, sem novas features, mas ainda suportado até 2028.`,(0,i.jsx)(`strong`,{children:`PowerShell 7+`}),` — `,(0,i.jsx)(`code`,{children:`pwsh.exe`}),`: cross-platform, novas features, instalação separada (winget install Microsoft.PowerShell).`]}),(0,i.jsx)(`h2`,{children:`Instalação e Identificação`}),(0,i.jsx)(t,{title:`Instalando e identificando o PS7`,code:`# Via Winget (recomendado)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Operadores Null-Coalescing e Null-Conditional`}),(0,i.jsx)(t,{title:`Tratamento elegante de valores nulos`,code:`# ?? — null coalescing (valor padrão quando null)
  $config   = $null
  ...
  `}),(0,i.jsx)(`h2`,{children:`Operador Ternário`}),(0,i.jsx)(t,{title:`Condicionais inline compactas`,code:`# condição ? valorVerdadeiro : valorFalso
  $idade     = 20
  ...
  `}),(0,i.jsx)(`h2`,{children:`ForEach-Object -Parallel`}),(0,i.jsx)(t,{title:`Processamento paralelo nativo (apenas PS7)`,code:`# Processar em paralelo — velocidade x N threads
  ...
  `}),(0,i.jsx)(`h2`,{children:`Pipeline Chain Operators`}),(0,i.jsx)(t,{title:`&& e || para encadear comandos por resultado`,code:`# && — executa o próximo SOMENTE se o anterior teve sucesso ($LASTEXITCODE = 0)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Melhorias de Tratamento de Erros`}),(0,i.jsx)(t,{title:`ErrorView, erros detalhados e Get-Error`,code:`# PS7 tem ErrorView conciso por padrão (não mais a pilha enorme)
  ...
  `}),(0,i.jsx)(`h2`,{children:`Web Cmdlets Melhorados`}),(0,i.jsx)(t,{title:`Invoke-RestMethod e Invoke-WebRequest no PS7`,code:`# Invoke-RestMethod agora suporta autenticação OAuth, seguir redirects e mais
  ...
  `}),(0,i.jsxs)(n,{type:`success`,title:`Migração PS5.1 → PS7`,children:[`A maioria dos scripts PS5.1 roda sem modificação no PS7. Os pontos de atenção são: módulos de administração do Windows que usam COM/DCOM (use compat layer com`,(0,i.jsx)(`code`,{children:`Import-Module -UseWindowsPowerShell`}),`), `,(0,i.jsx)(`code`,{children:`-Encoding Default`}),`que muda de ANSI para UTF-8, e `,(0,i.jsx)(`code`,{children:`$null -eq @()`}),` que agora é `,(0,i.jsx)(`code`,{children:`False`}),`.`]})]})}export{a as default};